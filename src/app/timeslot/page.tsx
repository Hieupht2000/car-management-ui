...
export default function TimeSlotPage() {
    ...
    const filterTimeSlots = () => {
        ...
        if (filterAvailable === "available") {
            filtered = filtered.filter(ts => ts.isAvailable);
    ...
    const stats = {
        ...
        available: timeSlots.filter(ts => ts.isAvailable).length,
        unavailable: timeSlots.filter(ts => !ts.isAvailable).length,
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                    ...
                    <div className="bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl p-6 text-white shadow-lg">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-orange-100 text-sm font-medium">unavailable</p>
                                <p className="text-3xl font-bold mt-2">{stats.unavailable}</p>
                            </div>
                            <div className="p-4 bg-white/20 rounded-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {filteredTimeSlots.map((timeSlot) => (
                        <div
                            ...
                            className={`rounded-2xl shadow-lg overflow-hidden border-2 transition-all hover:shadow-xl ${timeSlot.isAvailable
                                ? 'bg-white border-green-200 hover:border-green-400'
                                : 'bg-gray-50 border-gray-300'
                                }`}
                        >
                            <div className={`p-4 ${timeSlot.isAvailable ? 'bg-gradient-to-r from-green-500 to-emerald-600' : 'bg-gradient-to-r from-gray-400 to-gray-500'}`}>
                                <div className="flex items-center justify-between">
                            ...
                            <div className="p-5 space-y-4">
                                ...
                                <div className="flex items-center justify-center">
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-lg font-semibold text-sm transition-all ${timeSlot.isAvailable
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div>
                        <label className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                            ...
                            />
                            <div>
                                <span className="text-sm font-semibold text-gray-900">Still available</span>
                                <p className="text-xs text-gray-500">Scheduled time slots</p>
                            </div>
                        </label>
                    </div>
                </div>
