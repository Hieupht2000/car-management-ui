 ...
 * Admin-only view for managing all vehicles in the system
 */
"use client";
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 mt-1">Manage all vehicles in the system</p>
                        </div>
                    </div>
                </div>
                                ...
                                {filteredCars.length > 0 ? (
                                    filteredCars.map((car) => (
                                        <tr key={car.carId} className="hover:bg-blue-50/50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-gray-700">{car.fullName || "N/A"}</td>
